 ...
 */
object AdConstants {
    const val TAPPID = "1106662554"
    const val TBannerID = "6030189801366430"
    const val TInterstitialID = "9030688981739111"
    const val TNativeID = "5050420952467625"
    const val TSplashPosID = "1030527979166616"
    const val TRewardVideID = "4071205448165779"
